...
angular.module("adminApp")
    .controller("bannerController", ['$rootScope', '$scope', 'toaster', 'bannerService', 'bannerMappingService', 'checkFileNameService',
                                        '$sce', '$location', 'DTOptionsBuilder', 'DTColumnDefBuilder', '$stateParams', 'dialogs', '$state'
                                        , function ($rootScope, $scope, toaster, bannerService, bannerMappingService, checkFileNameService,
                                        $sce, $location, DTOptionsBuilder, DTColumnDefBuilder, $stateParams, dialogs, $state) {
