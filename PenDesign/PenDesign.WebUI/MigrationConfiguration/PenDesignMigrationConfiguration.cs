...
namespace PenDesign.WebUI.PenDesignMigrationConfiguration
{
    public class PenDesignMigrationConfiguration : DbMigrationsConfiguration<PenDesignDbContext>
    {
        ...
        protected override void Seed(PenDesignDbContext context)
        {
            ...
            //    {
            //        new Menu() { Name = "Giới thiệu", Url = "/gioi-thieu", Order = 1, Parent = 1, MenuController = "Home", MenuAction = "About", MenuNewsCategoryId = 0, Available = true},
            //        new Menu() { Name = "Dịch vụ", Url = "/dich-vu-1", Order = 2, Parent = 0, MenuController = "News", MenuAction = "List, Detail", MenuNewsCategoryId = 1, Available = true},
            //        new Menu() { Name = "Chương trình đào tạo", Url = "/chuong-trinh-dao-tao", Order = 3, Parent = 0, MenuController = "Course", MenuAction = "List, Detail", MenuNewsCategoryId = 0, Available = true},
            //        new Menu() { Name = "Kiến thức", Url = "/kien-thuc-3", Order = 4, Parent = 1, MenuController = "News", MenuAction = "List, Detail", MenuNewsCategoryId = 3, Available = true},
            //        new Menu() { Name = "Chuyên gia", Url = "/chuyen-gia-5", Order = 5, Parent = 1, MenuController = "News", MenuAction = "List, Detail", MenuNewsCategoryId = 5, Available = true},
            //        new Menu() { Name = "Đối tác", Url = "/doi-tac-4", Order = 6, Parent = 1, MenuController = "News", MenuAction = "List, Detail", MenuNewsCategoryId = 4, Available = true},
            //        new Menu() { Name = "Thư viện", Url = "/thu-vien", Order = 7, Parent = 0, MenuController = "Gallery", MenuAction = "Video, Image, Index", MenuNewsCategoryId = 0, Available = true},
            //        new Menu() { Name = "Liên hệ", Url = "/lien-he", Order = 8, Parent = 1, MenuController = "Home", MenuAction = "Contact", MenuNewsCategoryId = 0, Available = true},

            //    };

            //    menu.ForEach(m => context.Menus.AddOrUpdate(p => p.Name, m));
            ...
            if (context.Configs.Count() == 0)
            {
                ...
                {
                    CompanyName = "CÔNG TY TNHH ĐÀO TẠO VÀ TƯ VẤN TRUYỀN THÔNG THƯƠNG HIỆU BRAND",
                    About = "Công ty cổ phần giáo dục BRAND",
                    Slogan = "Thắp sáng thương hiệu",
                    Email = "mrthanh.testemail@gmail.com",
