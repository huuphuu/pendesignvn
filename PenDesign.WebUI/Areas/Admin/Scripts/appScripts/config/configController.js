...
angular.module("adminApp")
    .controller("configController", ['$rootScope', '$scope', 'toaster', 'configService', 'checkFileNameService',
                                        '$sce', '$location', 'DTOptionsBuilder', 'DTColumnDefBuilder', '$stateParams', 'dialogs',
                                        function ($rootScope, $scope, toaster, configService, checkFileNameService,
                                        $sce, $location, DTOptionsBuilder, DTColumnDefBuilder, $stateParams, dialogs) {
