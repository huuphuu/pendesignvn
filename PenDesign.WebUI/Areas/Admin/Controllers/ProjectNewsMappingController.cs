...
{
    public class ProjectNewsMappingController : ApiController
    {
        private INewsMappingService _newsMappingService;
        private UserFactory _userFactory;
        private string _userId;
        public ProjectNewsMappingController(INewsMappingService newsMappingService, UserFactory userFactory)
        {
