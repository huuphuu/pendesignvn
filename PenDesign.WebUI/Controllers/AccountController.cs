        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    return new HttpStatusCodeResult(HttpStatusCode.OK);  //return RedirectToLocal(returnUrl);
                //return RedirectToAction("Index", "Home", new { area = "Admin" });
                case SignInStatus.LockedOut:
                    return new HttpStatusCodeResult(HttpStatusCode.OK);  //return View("Lockout");
                case SignInStatus.RequiresVerification:
                    return RedirectToAction("SendCode", new { ReturnUrl = returnUrl, RememberMe = model.RememberMe });
                case SignInStatus.Failure:
                default:
                    return new HttpStatusCodeResult(HttpStatusCode.BadRequest);  //ModelState.AddModelError("", "Invalid login attempt.");
                //return View(model);
            }
        }
